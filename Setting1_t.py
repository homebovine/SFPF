...
true_beta1 = tc.zeros([rep_time, n, d])
...
###print results
with open('Setting1_t.pkl', 'rb') as f:  # Python 3: open(..., 'rb')
    opt_cluster_mem, opt_cluster_size, opt_cluster_num, adRI, est_betad, est_beta, est_beta0, est_etad, est_eta, est_etaupp,est_etalow, true_beta1, true_z, true_y,true_x, true_w, est_beta0upp, est_beta0low, est_std0, beta, alpha, lambda_tuning= pickle.load(f)
...
###The estimation results of Setting (1) in Table 3
