...
for rep in range(rep_time):
    ...
    print(adRI[rep, :])
    with open('Setting1_normal.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
        pickle.dump(
...
with open('Setting1_normal.pkl', 'wb') as f:
    pickle.dump(
        [opt_cluster_mem, opt_cluster_size, opt_cluster_num, adRI, est_betad, est_beta,
         est_beta0, est_etad, est_eta, est_etaupp,
         est_etalow, true_beta1,true_z, true_y,
...
###print results
with open('Setting1_normal.pkl', 'rb') as f:  # Python 3: open(..., 'rb')
...
###The estimation results of Setting (1) in Table 2
