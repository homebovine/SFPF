...
for rep in range(rep_time):
    ...
    print(adRI[rep, :])
    with open('Setting2_normal.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
        pickle.dump(
...
###print results
with open('/root/zyq/Conc1/Setting2_normal.pkl', 'rb') as f:  # Python 3: open(..., 'rb')
...
###The estimation results of Setting (2) in Table 2
