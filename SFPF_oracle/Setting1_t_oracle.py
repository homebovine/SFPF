...
for rep in range(rep_time):
    ...
    with open('Setting1_t_oracle.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
        pickle.dump(
...
###print results
with open('Setting1_t_oracle.pkl', 'rb') as f:  # Python 3: open(..., 'rb')
    est_betad, est_beta, est_beta0, est_etad, est_eta, est_etaupp,est_etalow, true_beta1, true_z, true_y,true_x, true_w, est_beta0upp, est_beta0low, est_std0= pickle.load(f)
